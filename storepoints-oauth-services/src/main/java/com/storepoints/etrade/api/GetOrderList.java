 ...
 * 
 */
public class GetOrderList extends ApiBase {
	
	private static final Log log = LogFactory.getLog(GetOrderList.class);
    ...
    public GetOrderList(String accessToken,String accessTokenSecret, String accountId) {
...
//    	this.apiPath="/accounts/sandbox/rest/accountlist";
    	...
    	this.apiPath="/order/rest/orderlist/"+this.accountId;

    }
    

    
    public  void orderList() throws ClientProtocolException,
    IOException, URISyntaxException, InvalidKeyException,
    NoSuchAlgorithmException {
    	
    	
    	String getOrdersListResponse=null;
...
//        qparams.add(new BasicNameValuePair("oauth_version", "1.0"));
        ...
        log.info("Get Order List from:"
                + uri.toString());

        HttpGet httpget = new HttpGet(uri);
        // output the response content.
        log.info("Get Order List Response:");
        ...
        if (entity != null) {
            ...
            while ((len = instream.read(tmp)) != -1) {
            	getOrdersListResponse=new String(tmp, 0, len, ENC);
            }
        }
        
        log.info("Get Orders List Response\n"+getOrdersListResponse);
